...
//    private static final TimeGrain GRAIN32 = new TimeGrain(32L, 31, DAY1, 16*60+45);
    ...
    @Test
    void penalizeUnassignedSatisfied() {
        MeetingAssignment firstMeeting = new MeetingAssignment(MEETING1, GRAIN1, PROSTORIJA_1);
        constraintVerifier.verifyThat(TimeTableConstraintProvider::penalizeUnassigned)
                .given(firstMeeting)
                .penalizesBy(0);
    }

    @Test
    void penalizeUnassignedNotSatisfied() {
        MeetingAssignment firstMeeting = new MeetingAssignment(MEETING1, null, PROSTORIJA_1);
        constraintVerifier.verifyThat(TimeTableConstraintProvider::penalizeUnassigned)
                .given(firstMeeting)
                .penalizesBy(1);
    }
